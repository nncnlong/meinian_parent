...
public class TravelGroupController {
    ...
    public Result delete(Integer travelGroupId){
        try {
            travelGroupService.deleteTravelGroup(travelGroupId);
    ...
    @RequestMapping("/edit")
    public Result edit(Integer[] travelItemIds,@RequestBody TravelGroup travelGroup) {//接受两部分数据
        try {
    ...
    @RequestMapping("/add")
    public Result add(Integer[] travelItemIds,@RequestBody TravelGroup travelGroup){//接受两部分数据
        try {
